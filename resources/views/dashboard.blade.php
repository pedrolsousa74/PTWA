...
@section('title', 'Post.it - Painel do Utilizador')
@vite('resources/css/app.css')

<!-- Marcar esta página como dashboard-page para o JavaScript saber -->
<div class="dashboard-page" style="display: none;"></div>
...
@section('content')    <!-- Boas-vindas no topo da página -->
    <div class="bg-purple-800 text-white py-10 px-6 shadow-md relative">
        <div class="absolute inset-0 bg-pattern opacity-10"></div>
        <!-- Elementos decorativos sutis -->
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
            <div class="absolute w-40 h-40 bg-yellow-400 rounded-full opacity-5 top-10 right-10"></div>
            <div class="absolute w-32 h-32 bg-purple-500 rounded-full filter blur-2xl opacity-10 bottom-0 left-10"></div>
        </div>
        <div class="container mx-auto relative z-10">
            <div class="flex flex-col sm:flex-row items-center sm:items-center justify-between">
                <div class="flex items-center mb-6 sm:mb-0">
                    <div class="mr-5">
                        <div class="w-20 h-20 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-300 flex items-center justify-center text-purple-800 text-3xl font-bold shadow-lg border-2 border-yellow-300">
                            {{ substr(auth()->user()->name, 0, 1) }}
                        </div>
                    </div>
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold">Bem-vindo, <span class="text-yellow-400">{{ auth()->user()->name }}</span>!</h1>
                        <p class="text-purple-200 text-base mt-2">Confira as novidades</p>
                    </div>
                </div>
